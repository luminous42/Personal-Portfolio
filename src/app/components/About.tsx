...
const About: React.FC<NavBarProps> = ({ isDarkMode }) => {
  return (
    <motion.div
      id="about"
      className="w-full px-[12%] py-10 scroll-mt-20 overflow-x-hidden"
      initial={{ opacity: 0 }}
    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          viewport={{ once: false }}
        >
          <p className="mb-8 lg:mb-10 max-w-2xl font-Ovo text-sm sm:text-base">
          ...
          <div className="w-full overflow-hidden">
            <div className="w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] ">
              <InfiniteSlider
                tools={toolsData.map(({ icon, title }) => ({
                  name: title,
                  icon: icon,
                }))}
